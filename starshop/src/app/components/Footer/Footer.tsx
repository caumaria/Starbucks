...
export default function Footer() {
  return (
    <FooterContainer>
      ...
      <span>
        A Nestlé usa as marcas registradas da Starbucks sob licença. Pike Place
        é uma marca registrada do Pike Place Market PDA, usado sob licença.
        Nespresso e NESCAFÉ Dolce Gusto são marcas registradas da Société des
        Produits Nestlé S.A.. Todas as outras marcas são de propriedade de seus
        proprietários.
      </span>
    </FooterContainer>
  );
